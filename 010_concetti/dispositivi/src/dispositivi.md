...
Le SVI vengono spesso rappresentate esternamente nei diagrammi, ma in realtà sono interne allo switch:  
sono interfacce **logiche**, non sono porte fisiche, sono configurazioni software associate alle VLAN e utilizzate come gateway IP delle subnet.
<br/><br/>
...
* **10 Gbps** → spesso usato per uplink (collegamento verso un livello superiore della rete)

...
- **routing inter-VLAN sul core switch Layer 3 con ACL**, riservando il firewall per il traffico verso Internet, VPN e policy di alto livello.
...
**Il routing tra VLAN viene gestito dal core switch L3**, che applica ACL per controllare il traffico tra reparti secondo le policy definite. Il firewall perimetrale si occupa del traffico verso Internet, della VPN site-to-site e della protezione dai threat esterni. Questa architettura evita colli di bottiglia sul firewall, che in una rete di oltre 200 host non sarebbe in grado di gestire tutto il traffico inter-VLAN senza degradare le prestazioni.
...
Firewall / NGFW nuova sede
  |  (solo traffico Internet e VPN)
  | 
  |--- VPN IPsec site-to-site --- Sede centrale
  |                              |-- Project repository remoto
  |                              |-- Sistema gestionale remoto
  |
Core switch L3 / Distribution (routing inter-VLAN + ACL)
  |
...
+----------------------------------------------------------------------------+
        |
        |||||||| Tunnel IPsec site-to-site (cifrato) ||||||||
        |
+----------------------------------------------------------------------------+
| DISPOSITIVO AZIENDALE                                                      |
...
Reparto D (Test QA)
    ...
    -> puo avviare la procedura di finalizzazione progetto

Reparto E (Project Management)  
    -> accesso ai File Server A/B/C  
    -> trasferimento versioni finali verso sede centrale (via CI/CD o script)
...
| VLAN | Nome rete        | Subnet        | Gateway    | Host utilizzabili (incluso gateway) | Primo IP per client | Uso                        |
| ---: | ---------------- | ------------- | ---------- | ----------------------------------- | ------------------- | -------------------------- |
|   10 | Utenti reparto A | 10.24.10.0/26 | 10.24.10.1 | 10.24.10.1 - 10.24.10.62            | 10.24.10.2          | PC sviluppo mobile         |
|   11 | Server reparto A | 10.24.11.0/28 | 10.24.11.1 | 10.24.11.1 - 10.24.11.14            | 10.24.11.2          | file server A, stampante A |
|   20 | Utenti reparto B | 10.24.20.0/26 | 10.24.20.1 | 10.24.20.1 - 10.24.20.62            | 10.24.20.2          | PC sviluppo web            |
|   21 | Server reparto B | 10.24.21.0/28 | 10.24.21.1 | 10.24.21.1 - 10.24.21.14            | 10.24.21.2          | file server B, stampante B |
|   30 | Utenti reparto C | 10.24.30.0/25 | 10.24.30.1 | 10.24.30.1 - 10.24.30.126           | 10.24.30.2          | PC sviluppo settore        |
|   31 | Server reparto C | 10.24.31.0/28 | 10.24.31.1 | 10.24.31.1 - 10.24.31.14            | 10.24.31.2          | file server C, stampante C |
|   40 | Reparto D        | 10.24.40.0/27 | 10.24.40.1 | 10.24.40.1 - 10.24.40.30            | 10.24.40.2          | test qualità               |
|   50 | Reparto E        | 10.24.50.0/28 | 10.24.50.1 | 10.24.50.1 - 10.24.50.14            | 10.24.50.2          | project manager            |
|   60 | Reparto F        | 10.24.60.0/27 | 10.24.60.1 | 10.24.60.1 - 10.24.60.30            | 10.24.60.2          | amministrazione            |
|   70 | Servizi locali   | 10.24.70.0/27 | 10.24.70.1 | 10.24.70.1 - 10.24.70.30            | 10.24.70.2          | AD/LDAP, DNS, DHCP, RADIUS |
|   80 | Management       | 10.24.80.0/28 | 10.24.80.1 | 10.24.80.1 - 10.24.80.14            | 10.24.80.2          | apparati e console admin   |
|   90 | WiFi ospiti      | 10.24.90.0/24 | 10.24.90.1 | 10.24.90.1 - 10.24.90.254           | 10.24.90.2          | ospiti, solo Internet      |
|   99 | Backup           | 10.24.99.0/27 | 10.24.99.1 | 10.24.99.1 - 10.24.99.30            | 10.24.99.2          | backup e replica           |

## 7. Matrice dei principali sistemi

| Sistema          |  VLAN | IP proposto     | Note                       |
| ---------------- | ----: | --------------- | -------------------------- |
| Gateway VLAN 10  |    10 | 10.24.10.1      | SVI sul core switch        |
| File server A    |    11 | 10.24.11.10     | accesso A, D, E            |
| Stampante A      |    11 | 10.24.11.11     | accesso solo A             |
| Gateway VLAN 20  |    20 | 10.24.20.1      | SVI sul core switch        |
| File server B    |    21 | 10.24.21.10     | accesso B, D, E            |
| Stampante B      |    21 | 10.24.21.11     | accesso solo B             |
| Gateway VLAN 30  |    30 | 10.24.30.1      | SVI sul core switch        |
...
| Core switch      | varie | .1 su ogni VLAN | gateway inter-VLAN         |
...
| VLAN | Nome rete      | Subnet        | Gateway    | Broadcast      | Primo host utente | Host utilizzabili | Dispositivi principali              |
| ---: | -------------- | ------------- | ---------- | -------------- | ----------------- | ----------------- | ----------------------------------- |
| 90   | WiFi ospiti    | 10.24.90.0/24 | 10.24.90.1 | 10.24.90.255   | 10.24.90.2        | 254               | client ospiti, solo Internet        |
| 30   | Reparto C      | 10.24.30.0/25 | 10.24.30.1 | 10.24.30.127   | 10.24.30.2        | 126               | PC C, File Server C, Stampante C    |
| 10   | Reparto A      | 10.24.10.0/26 | 10.24.10.1 | 10.24.10.63    | 10.24.10.2        | 62                | PC A, File Server A, Stampante A    |
| 20   | Reparto B      | 10.24.20.0/26 | 10.24.20.1 | 10.24.20.63    | 10.24.20.2        | 62                | PC B, File Server B, Stampante B    |
| 40   | Reparto D      | 10.24.40.0/27 | 10.24.40.1 | 10.24.40.31    | 10.24.40.2        | 30                | PC test qualità                     |
| 60   | Reparto F      | 10.24.60.0/27 | 10.24.60.1 | 10.24.60.31    | 10.24.60.2        | 30                | PC amministrazione                  |
| 70   | Servizi locali | 10.24.70.0/27 | 10.24.70.1 | 10.24.70.31    | 10.24.70.2        | 30                | AD/LDAP, DNS, DHCP, RADIUS, logging |
| 99   | Backup         | 10.24.99.0/27 | 10.24.99.1 | 10.24.99.31    | 10.24.99.2        | 30                | backup server, replica dati         |
| 50   | Reparto E      | 10.24.50.0/28 | 10.24.50.1 | 10.24.50.15    | 10.24.50.2        | 14                | PC project management               |
| 80   | Management     | 10.24.80.0/28 | 10.24.80.1 | 10.24.80.15    | 10.24.80.2        | 14                | apparati, console amministrazione   |
...
| Reparto D  | File server A/B/C                    | SMB/NFS + procedura finalizzazione| test qualità e report         |
...
| Reparto E  | Repository sede centrale             | Git/HTTPS su CI/CD pipeline       | trasferimento versioni finali |
...
TEST_QA accesso alle aree da validare con possibilità di avviare la procedura di finalizzazione,  
...
* ACL sul core switch L3 per controllare il traffico tra VLAN;  
...
* DHCP snooping (lo switch accetta risposte DHCP solo da server autorizzati, bloccando eventuali server DHCP falsi o malevoli presenti nella rete);  
...
- i dati trasferiti, progetti software, documentazione, dati amministrativi, possono considerarsi riservati;  
...
| ------------------- | -------------------------- | ------------------------------------------- | ----------------------------- |
| Reparto E           | Project repository         | Git over HTTPS (tramite CI/CD pipeline)     | trasferimento versioni finali |
...
Il repository remoto non viene esposto direttamente a Internet: viene raggiunto attraverso VPN. In una soluzione d'esame è preferibile indicare VPN site-to-site, perché collega stabilmente le due sedi e consente policy chiare.
...
10.24.50.0/28 può raggiungere 10.10.20.10 (tramite CI/CD),   
...
**Requisito della traccia**: gli operatori del reparto D devono potere "rinominare la cartella aggiungendo _Final_Version e renderla read-only".

**Soluzione implementata**: viene messa a disposizione del reparto D una procedura automatizzata (script o pulsante nell'interfaccia) che soddisfa integralmente il requisito.
...
**Procedura di finalizzazione progetto (accessibile agli operatori D):**

Lo script o il pulsante esegue le seguenti operazioni:

1. Verifica che l'operatore appartenga al gruppo TEST_QA
2. Controlla che il progetto in esame abbia superato i test
3. Scrive automaticamente il report nella cartella Report_Test
4. Rinomina la cartella del progetto da `NomeProgetto` a `NomeProgetto_Final_Version`
5. Modifica i permessi della cartella rendendola read-only per gli sviluppatori (DEV_A)

In questo modo:
- **L'operatore D** avvia la procedura (soddisfa il requisito "devono potere... rinominare")
- La procedura è **controllata** e non lascia libertà indiscriminata
- Il requisito **è pienamente rispettato**

Permessi consigliati:

| Cartella                 | DEV_A    | TEST_QA (operatori D) | PROJECT_MANAGER | IT_ADMIN           |
| ------------------------ | -------- | --------------------- | --------------- | ------------------ |
| In_Lavorazione           | modifica | solo lettura          | lettura         | controllo completo |
| In_Test                  | modifica | lettura + avvio finalizzazione | lettura    | controllo completo |
| Finali (dopo finalizzazione) | sola lettura | sola lettura     | modifica        | controllo completo |
| Report_Test              | lettura  | scrittura             | lettura/scrittura | controllo completo |

A finalizzazione avvenuta:
...
## 14. Configurazione del trasferimento al repository centrale

Quando una versione è marcata come finale, il contenuto viene trasferito al repository centrale.

**Nella realtà aziendale moderna**, questa operazione è affidata a una pipeline CI/CD (Continuous Integration/Continuous Delivery) che automatizza il processo. In assenza di tale infrastruttura, i project manager possono eseguire l'operazione tramite script automatizzati.

Protocollo consigliato:

- Git over HTTPS se si tratta di codice sorgente versionato (con push protetto da regole di branch)
- SFTP o FTPS per pacchetti, documentazione e manuali
- Integrazione con repository aziendale (GitLab, Bitbucket, Azure DevOps)

Esempio di pipeline CI/CD semplificata:

```
1. Lo sviluppatore pusha il codice su branch di release
2. Vengono eseguiti automaticamente i test
3. Se i test sono superati, il codice viene automaticamente taggato
4. La pipeline trasferisce l'artefatto al repository centrale
5. Viene aggiunta la documentazione associata
```
...
- Il reparto D riceve accessi specifici per il test qualità, inclusa la possibilità di avviare la finalizzazione dei progetti.  
- Il reparto E ha accesso più ampio perché deve consolidare le versioni finali.  
- Il reparto F ha accesso al gestionale remoto e a Internet, ma non ai sistemi tecnici degli sviluppatori.

La VPN site-to-site è la scelta più coerente per collegare sedi diverse in modo sicuro. Il routing inter-VLAN è gestito dal core switch L3 con ACL per evitare colli di bottiglia. La directory centralizzata garantisce autenticazione e autorizzazioni coerenti.
...
**Piano di indirizzamento per la sede centrale:**

| Zona | Subnet | Uso |
| ---- | ------ | --- |
| LAN interna | 10.10.0.0/20 | Postazioni utenti, server interni |
| DMZ | 10.10.16.0/28 | Web server, mail gateway |
| Management | 10.10.16.16/28 | Apparati di rete |
...
```
    ...
    Firewall perimetrale / NGFW
        |
        |-- DMZ (10.10.16.0/28)
        |     |-- Web server e-commerce (10.10.16.10)
        |     |-- Mail gateway (10.10.16.11)
        |
        |-- LAN sede centrale (10.10.0.0/20)
              |-- Project repository (10.10.10.10)
              |-- Sistema gestionale (10.10.10.20)
              |-- Database interni
              |-- Postazioni utenti
```
...
rectangle "DMZ pubblica (10.10.16.0/28)" as DMZ {
  node "Web server e-commerce\n10.10.16.10\nHTTPS 443" as WEB
  node "Mail gateway\n10.10.16.11\nSMTP / Antispam / Antivirus" as MAIL
}

rectangle "LAN sede centrale (10.10.0.0/20)" as LAN {
  node "Project repository\n10.10.10.10" as REPO
  node "Sistema gestionale\n10.10.10.20" as ERP
...
**Nota:** in una infrastruttura virtualizzata il server fisico con hypervisor viene normalmente collegato direttamente allo switch centrale tramite una o più interfacce Ethernet fisiche. Su quel collegamento transitano le diverse VLAN mediante trunk IEEE 802.1Q.
...
**Tipo 1 (native/bare-metal):** installato direttamente sull'hardware fisico, **senza sistema operativo** ospitante tradizionale. È più adatto ai server aziendali perché offre **migliori prestazioni**, maggiore isolamento e gestione più **professionale**.

**Tipo 2 (hosted):** installato sopra un sistema operativo già esistente, ad esempio Windows o Linux desktop. È più adatto a laboratori, test e uso didattico, ma meno indicato per server di produzione.

Esempi:  
- tipo 1: VMware ESXi, Microsoft Hyper-V Server, Proxmox VE  
- tipo 2: Oracle VirtualBox, VMware Workstation, Parallels Desktop
...
ormai insicuro. Usa meccanismi crittografici deboli (cifratura RC4 con chiavi statiche) e può essere violato con strumenti comuni in pochi minuti. Non deve essere usato in una rete aziendale.

**WPA (Wi-Fi Protected Access):**  
soluzione transitoria per superare WEP. Introduce TKIP (Temporal Key Integrity Protocol) che cambia dinamicamente la chiave per ogni pacchetto. Migliora la sicurezza, ma oggi è superato e **non dovrebbe essere scelto** per una nuova infrastruttura.

**WPA2:**  
è stato per anni lo standard principale. Utilizza AES-CCMP, molto più sicuro di TKIP.  
- **WPA2-Personal (PSK):** si usa una password condivisa (Pre-Shared Key). È adatto a reti domestiche o piccole reti non critiche.  
- **WPA2-Enterprise:** usa autenticazione **individuale** tramite server RADIUS e credenziali personali (username/password o certificati). Per un'azienda, WPA2-Enterprise è molto più corretto di WPA2-Personal.

**WPA3:**  
evoluzione più recente (2018). Offre:  
- SAE (Simultaneous Authentication of Equals) al posto del PSK, proteggendo da attacchi offline al dizionario  
- Cifratura individualizzata dei dati (ogni client deriva una chiave unica, senza condividere una password comune)  
- GCMP-256 per chiavi più robuste  
- Protezione da attacchi di de-autenticazione (Management Frame Protection obbligatoria)  


**Scelta per questo caso d'uso:**  
nella sede aziendale è opportuno usare WPA2-Enterprise o WPA3-Enterprise, con autenticazione **personale** degli utenti, integrazione con directory aziendale (es. Active Directory) e separazione in VLAN.

Esempio di reti WiFi:

- **SSID aziendale dipendenti:** WPA2/WPA3-Enterprise, autenticazione individuale (RADIUS + AD), accesso alle VLAN autorizzate in base al gruppo dell'utente
...
**Packet filtering firewall/stateless:** controlla pacchetti singolarmente in base a indirizzi IP, porte e protocolli. È semplice e veloce, ma non comprende il contenuto applicativo né lo stato della connessione.

**Stateful firewall:** tiene conto dello stato delle connessioni. Mantiene una tabella delle connessioni attive e permette il traffico di ritorno solo se corrisponde a una connessione già aperta. È più sicuro del semplice packet filtering.

**NGFW (Next Generation Firewall):**  
integra funzioni più avanzate, come controllo applicativo (identifica applicazioni anche se cambiano porta), IPS integrato, filtraggio URL, ispezione TLS, integrazione con utenti o gruppi (non solo IP).

**Suddivisione basata su impiego:**
- **Edge/perimeter firewall:** separazione/protezione rispetto a WAN/Internet
- **Firewall interno (o di segmentazione):** separa reparti, server e reti amministrative. Nel nostro caso è importante perché i reparti A, B e C non devono accedere tra loro, mentre D ed E devono avere permessi specifici sui file server.

**Application gateway / proxy:**

Un **proxy** è un intermediario applicativo che agisce per conto del client (proxy forward) o del server (proxy reverse). Lavora a livello applicativo, non limitandosi a vedere indirizzo IP e porta, ma interpretando il protocollo applicativo (es. HTTP, HTTPS, FTP).

- **Proxy forward (web proxy):** utilizzato dai client aziendali per navigare verso Internet. Può filtrare siti, registrare accessi, applicare policy aziendali, bloccare contenuti non ammessi e migliorare le prestazioni tramite cache.

- **Reverse proxy:** si pone davanti a uno o più server backend. Termina le connessioni TLS, distribuisce il carico (load balancing), nasconde i server interni. Un **WAF (Web Application Firewall)** è un tipo specializzato di reverse proxy che ispeziona il traffico HTTP/HTTPS a livello applicativo per bloccare attacchi come SQL injection, XSS e richieste HTTP anomale.

**Differenza essenziale tra firewall e proxy:**

- Il **firewall** decide se un traffico tra reti è consentito o bloccato in base a regole (operando fino al livello di trasporto, o applicativo per NGFW)
- Il **proxy** agisce come intermediario applicativo tra client e servizio richiesto, potendo modificare, filtrare, terminare o reindirizzare la connessione

**Utilizzo nel nostro scenario:**

- **Firewall perimetrale (NGFW):** protegge l'accesso Internet, gestisce NAT, VPN site-to-site, regole in ingresso e uscita, IDS/IPS
- **Firewall interno / ACL sul core switch L3:** impedisce il traffico non autorizzato tra reparti (sviluppatori A/B/C non comunicano tra loro)
- **Proxy web:** controlla e filtra la navigazione Internet degli utenti aziendali
- **Reverse proxy / WAF:** protegge il sito e-commerce della sede centrale da attacchi applicativi
- **IDS/IPS:** rileva o blocca traffico sospetto, utile sia sul perimetro sia tra zone interne importanti

**In sintesi:** per questa azienda non basta un solo firewall "verso Internet". È necessario anche controllare il traffico tra reparti e server interni (traffico Est-Ovest) perché sono richiesti permessi diversi per sviluppatori, tester, project manager e amministrazione.
